...
| **Frontend UI** | **React 19** | React + TypeScript | Interactive student dashboard & modal interfaces |
| **Build Tool** | **Vite** | 6.x | High-speed local development server & bundler |
| **Styling** | **Tailwind CSS** | 4.x | Responsive modern dark layout and components |
...
| **TC-05** | Exit application (choice `7`), reload application. | `FileManager` reads `tasks.txt` and restores all tasks with correct IDs. | ✅ PASS |
...
- [x] **Project Report**: Academic report ready in `PROJECT_REPORT.md`.
